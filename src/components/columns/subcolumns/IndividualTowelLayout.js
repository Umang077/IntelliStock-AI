...
function IndividualTowelLayout(props) {
  ...
  console.log("IndividualTowelLayout", props.towel_name);
    ...
    fetch(url)
      ...
      .then((value) => {
        ...
        console.log(
          ...
          value.filter(
            (value) =>
              value.towel_name == props.towel_name && value.is_deleted === 0
          )
        );
        setData(
          value.filter(
...
export default IndividualTowelLayout;
